...
import myImage from '../img/selfphoto.jpeg'; 
...
function About() {
    ...
    return (
        <section id="about">
            ...
            <img src={myImage} alt="java" width="384" height="1045"/> 
            ...
            <p class="intro">An wistful <code>customer Service Assistant</code> with 2 years of experiecnce in handling inquiries, resolving issues, and ensuring customer satisfaction. </p>
